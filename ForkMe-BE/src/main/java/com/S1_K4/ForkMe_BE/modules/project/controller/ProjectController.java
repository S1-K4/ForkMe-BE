...
public class ProjectController {
    ...
    * */
    ...
    public ResponseEntity<ApiResponse<ProjectDetailResponseDTO>> getProjectDetail(
    ...
    * 프로젝트 수정폼 호출
    * */
    @Operation(summary = "프로젝트 수정폼 조회")
    @GetMapping("/{projectPk}/update-form")
    public ResponseEntity<ApiResponse<ProjectUpdateFormDTO>> getProjectUpdateForm(
            @Parameter(description = "프로젝트 PK", example = "1")
            @PathVariable Long projectPk,
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        Long userPk = userDetails.getUserPk();
    ...
    * 프로젝트 상태 수정(기획 -> 모집)
    * */
    @Operation(summary = "프로젝트 상태 수정(기획 -> 모집)")
     ...
     * 프로젝트 상태 수정(모집 -> 진행)
     * */
    @Operation(summary = "프로젝트 상태 수정(모집 -> 진행)")
     ...
     * 프로젝트 상태 수정(진행 -> 충원)
     * */
    @Operation(summary = "프로젝트 상태 수정(진행 -> 충원)")
     ...
     * 프로젝트 상태 수정(진행 -> 종료)
     * */
    @Operation(summary = "프로젝트 상태 수정(진행 -> 종료)")
